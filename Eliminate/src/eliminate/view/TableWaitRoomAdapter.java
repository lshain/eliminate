...
/**
 * The Class TableWaitRoomAdapter.
 */
public class TableWaitRoomAdapter extends MouseAdapter {
	...
	/**
	 * Instantiates a new table wait room adapter.
	 * 
	 * @param table
	 *            the table
	 */
	public TableWaitRoomAdapter(JTable table) {
		this.table = table;
	}
